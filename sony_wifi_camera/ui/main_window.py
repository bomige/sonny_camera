...
class SonyCameraApp(QMainWindow):
    ...
    def __init__(self):
        ...
        # Single camera mode (USB)
        self.camera: SonyUSBCamera = None
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Sony Camera USB Remote")
        ...
        # Info label
        info_label = QLabel("Sony Camera USB Remote\npysonycam + PyQt5")
        ...
        self.status_bar.showMessage("Ready - Connect camera via USB and click Connect")
